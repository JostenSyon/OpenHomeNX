...
// OpenHomeNX: devkitA64 GCC 15.2 non cerca -I per #embed (solo "..."
// accanto al sorgente) — quindi quoted + binari in source/exefs/.
// Upstream usa <...>; al merge tenere la forma che compila qui.
...
// OpenHomeNX: core-launch + wrapper App::Push esclusi (trascinerebbero
// l'intera app Sphaira). Resta solo install_forwarder(pbox*,...) qui sotto.
// Per riattivarli: -DSPHAIRA_ENABLE_CORE_LAUNCH=1 (richiede app.hpp/fs/nro veri).
#if SPHAIRA_ENABLE_CORE_LAUNCH
...
#endif // SPHAIRA_ENABLE_CORE_LAUNCH (core-launch + wrapper App::Push sopra)
