...
static const Theme themes[THEME_COUNT] = {
    // ===== 0: OH (chiaro, da descrizione utente mappata sui token App.css) =====
    ...
    // ===== 1: OH - Dark (OpenHome desktop dark palette, App.css) =====
    {
        .name            = "OH - Dark",
        ...
        .selected        = {0xB8, 0xE6, 0xD5, 255},     // teal-chiaro: leggibile su menuHighlight
    ...
    // ===== 3: HOME (Pokemon HOME-inspired light pastel theme) =====
    {
        .name            = "HOME",
        .bg              = {235, 240, 245, 255},
    ...
    // ===== 4: HOME - Violet (Pokemon HOME Violet Pokedex theme) =====
    {
        .name            = "HOME - Violet",
    ...
    // ===== 5: HOME - Blue (Pokemon HOME GTS-style blue theme) =====
    {
        .name            = "HOME - Blue",
    ...
    // ===== 6: HOME - Green (Pokemon HOME green variant) =====
    {
        .name            = "HOME - Green",
    ...
    // ===== 7: HOME - Red (Pokemon HOME red variant) =====
    {
        .name            = "HOME - Red",
    ...
    // ===== 8: Pikachu (bright yellow & brown, Pikachu colors) =====
    {
        .name            = "Pikachu",
