...
impl MoveSlots {
    ...
    pub fn iter_mut(&mut self) -> core::slice::IterMut<'_, MoveSlot> {
        self.0.iter_mut()
    }
...
impl IntoIterator for MoveSlots {
    type Item = MoveSlot;
    type IntoIter = core::array::IntoIter<MoveSlot, 4>;
...
impl<'a> IntoIterator for &'a MoveSlots {
    ...
    type IntoIter = core::slice::Iter<'a, MoveSlot>;
...
impl<'a> IntoIterator for &'a mut MoveSlots {
    ...
    type IntoIter = core::slice::IterMut<'a, MoveSlot>;
...
#[allow(clippy::missing_const_for_fn)]
impl MoveIndex {
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = index))]
