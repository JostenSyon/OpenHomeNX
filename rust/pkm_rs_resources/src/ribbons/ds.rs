...
impl<'de> Deserialize<'de> for DsGen3Ribbon {
    fn deserialize<D>(deserializer: D) -> core::result::Result<DsGen3Ribbon, D::Error>
    where
        D: Deserializer<'de>,
    {
        let string_value = String::deserialize(deserializer)?;

        Self::from_name(&string_value).ok_or(D::Error::custom(alloc::format!(
...
impl<'de> Deserialize<'de> for Gen4StandardRibbon {
    fn deserialize<D>(deserializer: D) -> core::result::Result<Gen4StandardRibbon, D::Error>
    where
        D: Deserializer<'de>,
    {
        let string_value = String::deserialize(deserializer)?;
...
impl<'de> Deserialize<'de> for Gen4ContestRibbon {
    fn deserialize<D>(deserializer: D) -> core::result::Result<Gen4ContestRibbon, D::Error>
    where
        D: Deserializer<'de>,
    {
        let string_value = String::deserialize(deserializer)?;
...
impl<'de> Deserialize<'de> for DsRibbon {
    fn deserialize<D>(deserializer: D) -> core::result::Result<DsRibbon, D::Error>
    where
        D: Deserializer<'de>,
    {
        let string_value = String::deserialize(deserializer)?;
        ...
        Err(D::Error::custom(alloc::format!(
...
impl DsRibbonSet {
    ...
    pub fn to_bytes(self) -> Vec<u8> {
        let mut bytes: Vec<u8> = alloc::vec![0; 8];
...
impl<'de> Deserialize<'de> for DsRibbonSet {
    fn deserialize<D>(deserializer: D) -> core::result::Result<DsRibbonSet, D::Error>
    where
        D: Deserializer<'de>,
    {
