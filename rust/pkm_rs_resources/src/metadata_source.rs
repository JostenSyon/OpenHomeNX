...
impl MetadataSource {
    ...
    pub fn all_origin_games(self) -> Vec<OriginGame> {
        match self {
            Self::RedBlue => alloc::vec![OriginGame::Red, OriginGame::BlueGreen, OriginGame::BlueJpn],
            Self::Yellow => alloc::vec![OriginGame::Yellow],
            Self::GoldSilver => alloc::vec![OriginGame::Gold, OriginGame::Silver],
            Self::Crystal => alloc::vec![OriginGame::Crystal],
            Self::RubySapphire => alloc::vec![OriginGame::Ruby, OriginGame::Sapphire],
            Self::Emerald => alloc::vec![OriginGame::Emerald],
            Self::FireRedLeafGreen => alloc::vec![OriginGame::FireRed, OriginGame::LeafGreen],
            Self::DiamondPearl => alloc::vec![OriginGame::Diamond, OriginGame::Pearl],
            Self::Platinum => alloc::vec![OriginGame::Platinum],
            Self::HeartGoldSoulSilver => alloc::vec![OriginGame::HeartGold, OriginGame::SoulSilver],
            Self::BlackWhite => alloc::vec![OriginGame::Black, OriginGame::White],
            Self::Black2White2 => alloc::vec![OriginGame::Black2, OriginGame::White2],
            Self::XY => alloc::vec![OriginGame::X, OriginGame::Y],
            Self::OmegaRubyAlphaSapphire => alloc::vec![OriginGame::OmegaRuby, OriginGame::AlphaSapphire],
            Self::SunMoon => alloc::vec![OriginGame::Sun, OriginGame::Moon],
            Self::UltraSunUltraMoon => alloc::vec![OriginGame::UltraSun, OriginGame::UltraMoon],
            Self::LetsGoPikachuEevee => alloc::vec![OriginGame::LetsGoPikachu, OriginGame::LetsGoEevee],
            Self::SwordShield => alloc::vec![OriginGame::Sword, OriginGame::Shield],
            Self::BrilliantDiamondShiningPearl => {
                alloc::vec![OriginGame::BrilliantDiamond, OriginGame::ShiningPearl]
            }
            Self::LegendsArceus => alloc::vec![OriginGame::LegendsArceus],
            Self::ScarletViolet => alloc::vec![OriginGame::Scarlet, OriginGame::Violet],
            Self::LegendsZa => alloc::vec![OriginGame::LegendsZa],
        }
    }
