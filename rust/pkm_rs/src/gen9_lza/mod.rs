...
impl PlusMoveFlags {
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = fromByteBlocks))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = getMoveIds))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = addMoveIds))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = toBlockCBytes))]
    pub fn to_block_c_bytes_wasm(&self) -> Vec<u8> {
        self.block_c.to_bytes().to_vec()
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = toBlockBBytes))]
    pub fn to_block_b_bytes_wasm(&self) -> Vec<u8> {
        self.block_b.to_bytes().to_vec()
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = addAllFrom))]
    pub fn add_all_from_wasm(&mut self, other: &PlusMoveFlags) {
        self.add_all_from(other);
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = withAllForSpeciesAtLevel))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = containsAllFrom))]
