...
impl SwordShieldSave {
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = getMonAt))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = setMonAt))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = emptyBoxSlotBytes))]
    pub fn empty_box_slot_bytes_wasm() -> Box<[u8]> {
        Self::empty_box_slot_bytes()
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = getBoxName))]
    pub fn box_name_wasm(&mut self, box_index: u8) -> core::result::Result<String, JsError> {
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = convertOhpkm))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = isValidSave))]
    pub fn is_valid_save_wasm(bytes: &[u8]) -> bool {
        Self::is_save(bytes)
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = displayId))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = MAX_BOX_COUNT))]
    pub fn max_box_count() -> u8 {
        MAX_BOX_COUNT
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = BOX_ROWS))]
    pub fn box_rows() -> u8 {
        BOX_ROWS
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = BOX_COLS))]
    pub fn box_cols() -> u8 {
        BOX_COLS
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = SLOTS_PER_BOX))]
    pub fn box_size() -> u8 {
        BOX_COLS * BOX_ROWS
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = currentPcBoxIdx))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = includesOrigin))]
    pub fn includes_origin_wasm(origin: OriginGame) -> bool {
        Self::includes_origin(origin)
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = fileIsSave))]
    pub fn file_is_save_wasm(bytes: &[u8]) -> bool {
        Self::is_save(bytes)
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = prepareBytesForSaving))]
...
mod tests {
    ...
    #[test]
    fn blocks_identical_after_serde() -> core::result::Result<(), Box<dyn core::error::Error>> {
        ...
        for block in &block_vec {
            ...
            let Some(original_block) = original_blocks_by_key.get(&key) else {
                return Err(alloc::format!("Block missing for key {key}").into());
            };
            ...
            tests::assert_unchanged(
                ...
                &original_block,
                Some(tests::context(
                    &alloc::format!("SwishCrypto block with key {key}"),
                    &save_path,
                )),
            )?;
        }
