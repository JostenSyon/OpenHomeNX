...
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = decryptBlocks))]
...
#[cfg(any(feature = "wasm", feature = "alloc"))]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = writeBlock))]
...
#[cfg(any(feature = "wasm", feature = "alloc"))]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = encryptBlocks))]
...
impl Block {
    ...
    pub fn into_object_data(self) -> core::result::Result<ObjectBlock, WrongBlockType> {
    ...
    pub fn into_array_data(self) -> core::result::Result<ArrayBlock, WrongBlockType> {
        let Block { key, data } = self;
        let block_type = data.block_type();
...
impl core::fmt::Display for WrongBlockType {
...
impl core::error::Error for WrongBlockType {}

impl From<WrongBlockType> for Error {
    fn from(value: WrongBlockType) -> Self {
        let message = alloc::format!("block with key {}", value.block_key);
...
impl core::fmt::Display for InvalidTypeId {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
...
impl core::error::Error for InvalidTypeId {}
...
#[cfg_attr(feature = "wasm", tsify(into_wasm_abi, from_wasm_abi))]
#[derive(Clone, Copy, PartialEq, Eq, Debug, Hash, serde::Serialize, serde::Deserialize, strum::Display)]
pub enum BoolType {
    Bool1,
    Bool2,
    Bool3,
...
pub enum BlockData {
    ...
    Value {
        ...
        #[cfg_attr(feature = "wasm", tsify(type = "Uint8Array<ArrayBuffer>"))]
        bytes: Vec<u8>,
    },
}
...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = blockTypeIndex))]
#[allow(clippy::missing_const_for_fn)]
pub fn block_type_index(type_id: BlockType) -> u8 {
    type_id.id()
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, serde::Serialize, serde::Deserialize, Hash, strum::Display)]
#[cfg_attr(feature = "wasm", derive(tsify::Tsify))]
#[cfg_attr(feature = "wasm", tsify(into_wasm_abi, from_wasm_abi))]
pub enum ScalarType {
    Bool(BoolType),
...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = scalarTypeSize))]
#[allow(clippy::missing_const_for_fn)]
...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = scalarTypeIndex))]
#[allow(clippy::missing_const_for_fn)]
