...
#[cfg_attr(feature = "wasm", wasm_bindgen(js_class = "Pk9Wasm"))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(setter = teraTypeOriginal))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = tmFlagsBaseGame))]
    pub fn tm_flags_base_game_wasm(&self) -> Vec<u8> {
        self.tm_flags_base_game.to_bytes().to_vec()
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = tmFlagsDlc))]
...
mod test {
    ...
    #[cfg(feature = "randomize")]
    #[test]
    fn to_from_bytes_random() -> core::result::Result<(), tests::TestErrorWithSeed> {
        for seed in 0..=1000 {
