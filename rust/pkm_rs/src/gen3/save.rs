// NOTE: this file is a misplaced copy of gen7_alola/save.rs — NOT a Gen3 save loader.
// A real Gen3 save loader must be ported from OpenHome upstream (andrewbenington/OpenHome).
...
mod tests {
    ...
    #[test]
    fn test_sm_encryption() -> core::result::Result<(), Box<dyn core::error::Error>> {
