...
impl Serialize for Pk3 {
    fn serialize<S>(&self, serialzier: S) -> core::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
...
#[cfg_attr(feature = "wasm", wasm_bindgen(js_class = Pk3Wasm))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = fromSlotBytes))]
#[cfg(feature = "wasm")]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = toBoxBytes))]
    pub fn to_box_bytes_wasm(&self) -> Box<[u8]> {
        self.to_box_bytes()
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = toPartyBytes))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(setter = nationalDex))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = heldItemName))]
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = refreshChecksum))]
    pub fn refresh_checksum_js(&mut self) {
        self.refresh_checksum();
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(getter = languageString))]
...
mod tests {
    ...
    fn to_from_bytes_random() -> core::result::Result<(), TestErrorWithSeed> {
        for seed in 0..=1000 {
            ...
            #[cfg(feature="std")] println!("Testing seed {seed}: {mon:#?}");
