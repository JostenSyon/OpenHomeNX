...
/// Source: PK5.ts upstream (andrewbenington/OpenHome)
...
impl PkmBytes for Pk5 {
    ...
    fn write_box_bytes(&self, _bytes: &mut [u8]) {
        // TODO: implement from upstream PK5.ts toBytes()
    }

    fn write_party_bytes(&self, _bytes: &mut [u8]) {
        // TODO: implement from upstream PK5.ts toBytes(includeExtraFields=true)
    }
...
impl Pk5 {
    ...
    fn from_box_bytes(bytes: &[u8]) -> Result<Self> {
        // TODO: implement from upstream PK5.ts constructor
        Ok(Self::default())
    }

    fn from_party_bytes(bytes: &[u8]) -> Result<Self> {
        // TODO: implement from upstream PK5.ts constructor with party fields
        Ok(Self::default())
    }
    ...
    pub fn calculate_checksum(&self) -> u16 {
        // TODO: implement from upstream PK5.ts calculateChecksum()
        0
    }
