...
impl OhpkmConvert for Pb8 {
    fn to_main_data(&self) -> ohpkm::v2_sections::MainDataV2 {
        ohpkm::v2_sections::MainDataV2 {
            ...
            ability_index: self
                .ability_index
                .change_bound()
                .expect("Pb8 max ability <= overall max ability"),
    ...
    fn from_ohpkm(ohpkm: &OhpkmV2, strategy: ConvertStrategy) -> Result<Self> {
        ...
        let converter = PkmConverter::new(PkmFormat::PB8, strategy);
        ...
        bytes
            ...
            .map_err(|_| {
                Error::buffer_size_with_source(
                    "Pb8::OhpkmConvert::bytes_to_stored",
                    gen8_bdsp::PKM_DATA_SIZE,
                    bytes.len(),
                )
            })
            .map(StoredPkmBytes::Pb8)
    }
}