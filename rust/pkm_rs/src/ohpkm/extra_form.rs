...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "orasFormIndexIfSupported"))]
...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "extraFormIndexFromOrasPikachu"))]
#[allow(clippy::missing_const_for_fn)]
...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "radicalRedSupportsExtraForm"))]
#[allow(clippy::missing_const_for_fn)]
...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "isSeviiForm"))]
#[allow(clippy::missing_const_for_fn)]
...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "luminescentSupportsExtraForm"))]
#[allow(clippy::missing_const_for_fn)]
...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "extraFormSpriteName"))]
pub fn extra_form_sprite_name(form: ExtraFormIndex) -> Option<String> {
    form.sprite_name()
}

#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "extraFormTypeOverride"))]
pub fn extra_form_type_override(form: ExtraFormIndex) -> Option<Vec<PkmType>> {
    match form.type_overrides() {
        Some((t1, Some(t2))) => Some(alloc::vec![t1, t2]),
        Some((t1, None)) => Some(alloc::vec![t1]),
        None => None,
    }
}

#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "extraFormsByNationalDex"))]
...
impl ExtraFormMetadata {
    pub fn from_base_metadata(base_form_metadata: FormMetadata, form: ExtraFormIndex) -> Self {
        Self {
            ...
            sprite: form.sprite_name().unwrap_or(base_form_metadata.sprite.to_owned()),
...
#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = genderFromAtkDv))]
    pub fn gender_from_atk_dv(&self, atk_dv: u8) -> Gender {
        self.gender_ratio.gender_for_atk_dv(atk_dv)
    }

#[cfg(feature = "wasm")]
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = genderFromPid))]
...
#[cfg(feature = "wasm")]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "extraFormMetadata"))]
