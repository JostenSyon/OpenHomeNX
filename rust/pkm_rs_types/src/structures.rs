...
impl PokeDate {
    ...
    #[cfg(not(feature = "std"))]
    pub fn today() -> Self {
        Self { year_minus_2000: 24, month: 1, day: 1 }
    }
}
...
impl ShinyLeaves {
    ...
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "fromByte"))]
    pub fn from_byte_js(byte: u8) -> Self {
        Self::from_byte(byte)
    }

    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "toByte"))]
    pub fn to_byte_js(&self) -> u8 {
        self.to_byte()
    }

    #[cfg(any(feature = "wasm", feature = "alloc"))]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "hasFirst"))]
    pub fn has_first(&self) -> bool {
        (self.0 & 0b00001) != 0
    }

    #[cfg(any(feature = "wasm", feature = "alloc"))]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "hasSecond"))]
    pub fn has_second(&self) -> bool {
        (self.0 & 0b00010) != 0
    }

    #[cfg(any(feature = "wasm", feature = "alloc"))]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "hasThird"))]
    pub fn has_third(&self) -> bool {
        (self.0 & 0b00100) != 0
    }

    #[cfg(any(feature = "wasm", feature = "alloc"))]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "hasFourth"))]
    pub fn has_fourth(&self) -> bool {
        (self.0 & 0b01000) != 0
    }

    #[cfg(any(feature = "wasm", feature = "alloc"))]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "hasFifth"))]
    pub fn has_fifth(&self) -> bool {
        (self.0 & 0b10000) != 0
    }

    #[cfg(any(feature = "wasm", feature = "alloc"))]
#[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "hasCrown"))]
    ...
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "clone"))]
...
impl Pokerus {
    ...
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "fromByteOrDefault"))]
    ...
    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "strain"))]
    pub fn strain_wasm(&self) -> u8 {
        self.strain().value()
    }

    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "daysRemaining"))]
    pub fn days_remaining_wasm(&self) -> u8 {
        self.days_remaining().value()
    }

    #[cfg_attr(feature = "wasm", wasm_bindgen(js_name = "status"))]
